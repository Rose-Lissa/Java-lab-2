...
import com.stackcalculator.commands.basicmath.Multiplication;
...
public class MultiplicationTest {
    ...
    public void constructorExceptions() {
        ...
        assertThrows(IllegalNumArgsException.class,
                () -> new Multiplication(Arrays.stream(highArgs).toList()));
    }

    @Test
    public void simpleMultiplication() throws CommandException, UnableGettingUnitException {
        Multiplication plus = new Multiplication(List.of());
        ...
        assertEquals(unit.getValue(), 13404.72);
    }
}
